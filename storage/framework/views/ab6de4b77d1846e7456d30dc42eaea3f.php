        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <table id="bootstrap-data-table-export" class="table table-striped table-bordered listTable">
                    ...
                    <tbody>
                    <?php $searchDanhGias = session('searchDanhGias') ?>
                    <?php if($searchDanhGias!=null): ?>
                        <?php
                    ...
                    <?php $__currentLoopData = $danhGias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $danhGia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e(\App\Models\User::find($danhGia->user_id)->name); ?></td>
                            <td  ><?php echo e(\App\Models\sanPham::find($danhGia->sanPham_id)->ten); ?></td>
                            <td ><?php echo e($danhGia->soSao); ?></td>
                            <td ><?php echo e($danhGia->danhGia); ?></td>
                            <td>
                                <form id="delete_<?php echo e($danhGia->id); ?>" class="deleteForm" action="/admins/admin/deleteDanhGia/<?php echo e($danhGia->id); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field("DELETE"); ?>
                                    <a class="nav-link btn btn-danger" href="#" onclick="deletee(<?php echo e($danhGia->id); ?>)"> Xóa</a>
                                </form>
                            </td>
                        </tr>
...
<?php echo $__env->make("admin.layout.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\btlNhom3-main\resources\views/admin/danhGia/danhGia.blade.php ENDPATH**/ ?>