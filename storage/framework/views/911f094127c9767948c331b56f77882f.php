        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <table id="bootstrap-data-table-export" class="table table-striped table-bordered listTable">
                    ...
                    <tbody>
                    <?php $searchUsers = session('searchUsers') ?>
                    ...
                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php endif; ?>
                        <tr>
                            <td style="max-width: 45px; overflow-x: "><?php echo e($user->id); ?></td>
                            <td style="max-width: 151px; overflow-x: <?php echo strlen($user->name) > 16 ? 'scroll' : 'hidden'; ?>"><?php echo e($user->name); ?></td>
                            <td ><?php echo e($user->hoTen); ?></td>
                            <td ><?php echo e($user->vaiTro); ?></td>
                            <td style="max-width: 114px; overflow-x: "><?php echo e($user->created_at); ?></td>
                            <td style="max-width: 114px; overflow-x: "><?php echo e($user->updated_at); ?></td>
                            <td style="max-width: 195px; overflow-x: "> <button type="button" class="btn btn-primary" data-toggle="modal" onclick="detail(<?php echo e(json_encode($user)); ?>)" data-target="#chitiet">
                                    Chi tiết
                                </button>
                                <?php if($adminId!=$user->id): ?>
                                    <form id="delete_<?php echo e($user->id); ?>" class="deleteForm" action="/admins/admin/deleteUser/<?php echo e($user->id); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field("DELETE"); ?>
                                        <a class="nav-link btn btn-danger" href="#" onclick="deletee(<?php echo e($user->id); ?>)"> Xóa</a>
                                    </form>
                                <?php endif; ?>
                            </td>
                        </tr>
...
<?php echo $__env->make("admin.layout.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\btlNhom3-main\resources\views/admin/acc/listAcc.blade.php ENDPATH**/ ?>