                ...
                <div class="col-lg-6">
                    <div class="">
                        <div class="single-prd-item">
                            <img class="img-fluid" src="/images/<?php echo e($sanPham->url); ?>" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="s_product_text">
                        <h3><?php echo e($sanPham->ten); ?></h3>
                        <h2><?php echo e($sanPham->giaBan); ?>đ</h2>
                        <ul class="list">
                            <li><a class="active" href="#"><span style="width: 92px">Loại sản phẩm</span> : <?php echo e($sanPham->tenDanhMuc); ?></a></li>
                            <li><a href="#"><span>Tình trạng</span>: <?php echo e($sanPham->tonKho==0 ? "Hết hàng":"Còn hàng"); ?></a></li>
                        </ul>
                        ...
                        <div class="card_area d-flex align-items-center">
                            <a class="primary-btn" id="gioHang" href="/user/themVaoGio?sanPhamId=<?php echo e($sanPham->id); ?>&soLuong=1&gia=<?php echo e($sanPham->giaBan); ?>">Thêm vào giỏ hàng</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade  show active" id="home" role="tabpanel" style="height: 600px;" aria-labelledby="home-tab">
                    ...
                    <textarea readonly name="moTa" id="textarea-input"  rows="25"  class="form-control moTa"> <?php echo e($sanPham->moTa); ?></textarea>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="row total_rate">
                                <div class="col-6">
                                    <div class="box_total">
                                        <h4><?php echo e(isset($tbc)?$formatted_number = number_format($tbc, 1, '.', '') : ""); ?></h4>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="rating_list">
                                        ...
                                        <ul class="list">
                                            <li><a href="#">5 sao <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i
                                                        class="fa fa-star"></i><i class="fa fa-star"></i> <?php echo e(isset($demSoSao)? $demSoSao[4] : 0); ?></a></li>
                                            <li><a href="#">4 sao <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i
                                                        class="fa fa-star"></i><i class="fa fa-star black"></i> <?php echo e(isset($demSoSao)? $demSoSao[3] : 0); ?></a></li>
                                            <li><a href="#">3 sao <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i
                                                        class="fa fa-star black"></i><i class="fa fa-star black"></i> <?php echo e(isset($demSoSao)? $demSoSao[2] : 0); ?></a></li>
                                            <li><a href="#">2 sao <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star black"></i><i
                                                        class="fa fa-star black"></i><i class="fa fa-star black"></i> <?php echo e(isset($demSoSao)? $demSoSao[1] : 0); ?></a></li>
                                            <li><a href="#">1 sao <i class="fa fa-star"></i><i class="fa fa-star black"></i><i class="fa fa-star black"></i><i
                                                        class="fa fa-star black"></i><i class="fa fa-star black"></i> <?php echo e(isset($demSoSao)? $demSoSao[0] : 0); ?></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="review_item">
                                            <div class="media">
                                                <div class="media-body">
                                                    <h4><?php echo e($danhGia->hoTen); ?></h4>
                                                    <?php for($i=1;$i<=5;$i++): ?>
                                                        <?php if($i<=$danhGia->soSao): ?>
                                            ...
                                            <p><?php echo e($danhGia->danhGia); ?></p>
                                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="review_box">
                                    ...
                                    <form class="row contact_form" action="/user/themDanhGia" method="post" id="contactForm" method="post" novalidate="novalidate">
                                        ...
                                        <input name="idHD" value="<?php echo e($idHD); ?>" hidden>
                                        <input name="soSao" id="soSao" value="1" hidden>
                                        <input name="idSP" id="idSP" value="<?php echo e($sanPham->id); ?>" hidden>
                                        <div class="col-md-12">
...
<?php $__env->startSection("src"); ?>
    <script>
        function soLuong(e){
            document.getElementById("gioHang").href = "/user/themVaoGio?sanPhamId=<?php echo e($sanPham->id); ?>&soLuong="+e+"&gia=<?php echo e($sanPham->giaBan); ?>"
        }
        function danhGia(e){
...
<?php echo $__env->make("user.layout.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\btlNhom3-main\resources\views/user/sanPham/chiTiet.blade.php ENDPATH**/ ?>