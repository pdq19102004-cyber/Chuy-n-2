...
<link rel="stylesheet" href="<?php echo e(asset('/admin/vendors/bootstrap/dist/css/bootstrap.min.css')); ?>" type="text/css" >
<link rel="stylesheet" href="<?php echo e(asset('/admin/vendors/font-awesome/css/font-awesome.min.css')); ?>" type="text/css" >
<link rel="stylesheet" href="<?php echo e(asset('/admin/vendors/themify-icons/css/themify-icons.css')); ?>" type="text/css" >
<link rel="stylesheet" href="<?php echo e(asset('/admin/vendors/flag-icon-css/css/flag-icon.min.css')); ?>" type="text/css" >
<link rel="stylesheet" href="<?php echo e(asset('/admin/vendors/selectFX/css/cs-skin-elastic.css')); ?>" type="text/css" >
<link rel="stylesheet" href="<?php echo e(asset('/admin/vendors/jqvmap/dist/jqvmap.min.css')); ?>" type="text/css" >

<link rel="stylesheet" href="<?php echo e(asset('/admin/assets/css/style.css')); ?>" type="text/css" >
            ...
            <div class="col-sm-5">
                <div class="user-area dropdown float-right">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img class="user-avatar rounded-circle" src="<?php echo e(url('/images/' . $url)); ?>"
...
<script src="<?php echo e(asset("admin/vendors/peity/jquery.peity.min.js")); ?>"></script>
<!-- scripit init-->
<script src="<?php echo e(asset("admin/assets/js/init-scripts/peitychart/peitychart.init.js")); ?>"></script>
<!-- scripit init-->
<script src=" <?php echo e(asset("mainfe.js")); ?> "></script>
<?php echo $__env->yieldContent('src'); ?>
<?php /**PATH C:\xampp\htdocs\btlNhom3-main\resources\views/admin/layout/layout.blade.php ENDPATH**/ ?>